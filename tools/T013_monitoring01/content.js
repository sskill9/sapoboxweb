...
(function () {
  ...
  if (!contentEl) return;
// ===== [INIT] CONTENT 初期化・差し込み開始 ここまで =====


// ===== [UI] CONTENT メインHTML生成 =====
  contentEl.innerHTML = `
...
`;
// ===== [UI] CONTENT メインHTML生成 ここまで =====


// ===== [UI] TOPへ戻るボタン 表示制御（scroll）＋クリック制御 ＋ 即時関数終了 =====
  // TOPへ戻るボタンの制御
...
// ===== [UI] TOPへ戻るボタン 表示制御（scroll）＋クリック制御 ＋ 即時関数終了 ここまで =====
